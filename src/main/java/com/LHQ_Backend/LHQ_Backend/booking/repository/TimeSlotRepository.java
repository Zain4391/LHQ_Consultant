...
public interface TimeSlotRepository extends JpaRepository<TimeSlot, String> {
        ...
        /**
         * Variant of overlap check that excludes a specific slot — used when updating an existing
         * slot.
         */
        @Query("""
                        SELECT COUNT(t) > 0 FROM TimeSlot t
        ...
        /**
         * Used by the scheduler to check if slots have already been generated for a template within
         * a given window — prevents duplicate generation on re-runs.
         */
        @Query("""
                        SELECT COUNT(t) > 0 FROM TimeSlot t
        ...
        /**
         * Fetches all available slots for a lawyer within a date range. Used by the booking flow to
         * show open slots to a user.
         */
        @Query("""
                        ...
                        """)
        List<TimeSlot> findAvailableSlots(@Param("lawyerId") String lawyerId,
